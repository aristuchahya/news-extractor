...
def parse(soup: BeautifulSoup, url: str) -> dict:
    ...
    author_el = soup.select_one(".credit-title-name, .read__credit__item")
    category_el = soup.select_one(".breadcrumb__item:last-child, .breadcrumb li:last-child")
    tag_els = soup.select(".tag__article__link, .tag a")
